...
function selectAttendanceReport(sval,code){
        ...
        var gadha= ['Select Company','Select Business','Select Sub-Business','Select Location','Select Work Location','Select Function','Select Sub-Function','Select Cost Master','Select Process','Select Grade', 'Select Designation'];
...
function attReport(){
        ...
        var Startdate = moment(fDate, "YYYY-MM-DD").format('YYYY-MM-DD');
        var Enddate = moment(tDate, "YYYY-MM-DD").format('YYYY-MM-DD');

        var dateFormat = "YYYY-MM-DD";

        var split_fdate = fDate.split("-");
        var split_tdate = tDate.split("-");
       // var day = currentDate.getDay();
            ...
            if(fDate != "")
            {
                if(moment(fDate, dateFormat, true).isValid() == false){
                    toasterrormsg("Incorrect To Date");
                return false;
                }
            ...
            if(tDate != "")
            {
                if(moment(tDate, dateFormat, true).isValid() == false){
                    toasterrormsg("Incorrect From Date");
                return false;
                }
            }
            ...
            if(fDate != "" && tDate != ""){
                if(split_tdate[1] != split_fdate[1]){
                    toasterrormsg("Only a month report can be downloaded");
                   return false;
                }
            }
        if(mainfil == 3){
